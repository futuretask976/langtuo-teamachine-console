...
import { isBlankStr, genGetUrlBySegs, getRespModel, handleRespError, isArray } from '../../js/common.js';
...
const OrderActRecordViewModal = (props) => {
    ...
    const fetchInvalidActRecord = () => {
        ...
        let url = genGetUrlBySegs('/recordset/order/{segment}/{segment}/get', ['tenant_001', props.idempotentMark4View]);
        axios.get(url, {
