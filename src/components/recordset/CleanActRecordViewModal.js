...
import { isBlankStr, genGetUrlBySegs, getRespModel, handleRespError } from '../../js/common.js';
...
const CleanActRecordViewModal = (props) => {
    ...
    const [openRuleCode, setOpenRuleCode] = useState('');
    const [closeRuleCode, setCloseRuleCode] = useState('');
    ...
    const fetchInvalidActRecord = () => {
        ...
        let url = genGetUrlBySegs('/recordset/clean/{segment}/{segment}/get', ['tenant_001', props.idempotentMark4View]);
        axios.get(url, {
                    ...
                    <Space direction='vertical' size={20} style={{width: '100%'}}>
                        ...
                        {cleanType == 2 &&
                            <Row style={{width: '100%'}}>
                                ...
                                <Col className="gutter-row" span={9}>
                                    <Input disabled={true} value={openRuleCode}/>
                                </Col>
                            </Row>
                        }
                        {cleanType == 3 &&
                            <Row style={{width: '100%'}}>
                                ...
                                <Col className="gutter-row" span={9}>
                                    <Input disabled={true} value={closeRuleCode}/>
                                </Col>
                            </Row>
                        }
                    </Space>
