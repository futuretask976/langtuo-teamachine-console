        ...
        },
        {
            ...
            render: (_, { seriesCode, actions }) => (
                ...
                {actions.map((action) => {
                    if (action === 'edit') {
                        return (
                            <a key={action + '_' + seriesCode} onClick={(e) => onClickEdit(e, seriesCode)}>{applyLang('labelEdit')}</a>
                        );
                    }
                    if (action === 'delete') {
                        return (
                            <a key={action + '_' + seriesCode} onClick={(e) => onClickDelete(e, seriesCode)}>{applyLang('labelDel')}</a>
                        );
                    }
                })}
                </Space>
