        ...
        },
        {
            ...
            render: (_, { shopCode, actions }) => (
                ...
                {actions.map((action) => {
                    if (action === 'edit') {
                        return (
                            <a key={action + '_' + shopCode} onClick={(e) => onClickEdit(e, shopCode)}>{applyLang('labelEdit')}</a>
                        );
                    }
                    if (action === 'delete') {
                        return (
                            <a key={action + '_' + shopCode} onClick={(e) => onClickDelete(e, shopCode)}>{applyLang('labelDel')}</a>
                        );
                    }
                })}
                </Space>
