...
import { Button, Input, Modal, Transfer, Col, Row } from 'antd';
import axios from 'axios';

import '../../css/common.css';
import { isArray, isBlankStr, genGetUrlByParams, genGetUrlBySegs, genPostUrl, isBlankArray } from '../../js/common.js';
...
const CleanRuleDispatchModal = (props) => {
    ...
    useEffect(() => {
        ...
        let url = genGetUrlBySegs('/ruleset/clean/dispatch/{segment}/{segment}/get', ['tenant_001', props.cleanRuleCode4Dispatch]);
        axios.get(url, {
            withCredentials: true // 这会让axios在请求中携带cookies
        })
        .then(response => {
