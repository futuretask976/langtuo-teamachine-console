        ...
        },
        {
            ...
            render: (_, { loginName, actions }) => (
                ...
                {actions.map((action) => {
                    if (action === 'edit') {
                        return (
                            <a key={action + '_' + loginName} onClick={(e) => onClickEdit(e, loginName)}>{applyLang('labelEdit')}</a>
                        );
                    }
                    if (action === 'delete') {
                        return (
                            <a key={action + '_' + loginName} onClick={(e) => onClickDelete(e, loginName)}>{applyLang('labelDel')}</a>
                        );
                    }
                })}
                </Space>
