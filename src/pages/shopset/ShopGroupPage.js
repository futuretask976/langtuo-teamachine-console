...
import ShopGroupListBlock from '../../components/shopset/ShopGroupListBlock'
import ShopGroupNewModal from '../../components/shopset/ShopGroupNewModal'
                        ...
                        <Layout>
                            <Content style={{ margin: '0px 5px 0px 5px' }}>
                                ...
                                <Row style={{backgroundColor: '#fff'}}>
                                    ...
                                    <Col className="gutter-row" span={3}>
                                        <div className="flex-row-cont">
                                            <Button type="primary" icon={<FormOutlined />} onClick={onOpenNewModal} style={{width: '80%'}}>新建门店组</Button>
                                        </div>
                                    </Col>
