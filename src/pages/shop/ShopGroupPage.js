...
const ShopGroupPage = () => {
    // 面包屑定义
    const breadcrumbPath = [applyLang('labelConsole'), applyLang('labelShopSet'), applyLang('labelShopGroupMgt')];
                    ...
                    <Row className="full-width" style={{height: 40}}>
                        ...
                        <Col className="gutter-row full-height" span={4}>
                            <div className="flex-row-cont full-height" style={{justifyContent: 'flex-start'}}>
                                <Input placeholder={applyLang('labelShopGroupName')} allowClear onChange={(e) => setShopGroupName4Search(e.target.value)} style={{width: '95%'}} />
                            </div>
                        </Col>
                        <Col className="gutter-row full-height" span={3}>
